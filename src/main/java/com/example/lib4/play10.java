...
public class play10 {
    ...
    private static void placeComponents(JPanel panel) {
        ...
        panel.add(t3);
        Random r = new Random();
        ans = r.nextInt(1000000) + 1;
        System.out.println(ans);
        t1.setText("0");
        t2.setText("5000000");
        Label.setText("Welcome to the 10 level");
        Button3 = new JButton("重來");
        Button3.setBounds(90, 550, 80, 80);
        panel.add(Button3);
